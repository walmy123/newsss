...
const textCounterTwo = document.querySelector(`.counter-text-two`)
...
const allShop = document.querySelector(`.shop`)
const closeShop = document.querySelector(`.close`)
const yesShop = document.querySelector(`.yes-shop`)
const notShop = document.querySelector(`.not-shop`)

textCounter.textContent = newCounter

closeShop.addEventListener("click", function(){

  yesShop.style.display="none";

  notShop.style.display="block";
...
allShop.addEventListener("click", function(){

  textCounterTwo.textContent = newCounter

  yesShop.style.display="block";

  notShop.style.display="none";
